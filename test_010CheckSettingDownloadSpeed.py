...
from test_case.OTAUtil import ConnectAppiumAndAction, CheckChangeWIFIDownloadSpeed
...
def test_main():
    ...
    assert CheckChangeWIFIDownloadSpeed('40KB/s') == True, '判断当前界面关闭WiFi自动下载后，退出重新进入应用是否自动下载'
